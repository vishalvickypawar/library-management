    ...
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div id="menu" style="max-width:inherit">
            <ul id="top" class="w3-navbar w3-light-grey w3-card-2">
                ...
                <li class="w3-hide-small w3-hide-medium"><a class="w3-hover-teal" href="home.do"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li class="w3-hide-medium"><a class="w3-teal" href="about.do"><i class="fa fa-sticky-note"></i> About Us</a></li>
                <li class="w3-hide-small w3-hide-large"><a class="w3-teal" href="about.do"><i class="fa fa-sticky-note"></i> About</a></li>
            ...
            <ul id="down-menu" class="w3-navbar w3-light-grey w3-hide-medium w3-hide-large w3-card-2" style="display:none">
                <li><a class="w3-hover-teal" href="home.do"><i class="fa fa-home"></i> Home</a></li>
                  ...
                  <li class="w3-padding-16 w3-row-padding w3-margin-right">
                  	<div class="w3-container w3-teal w3-center"><h3><i class="fa fa-question-circle"></i> Queries</h3></div>
                        <div class="w3-half">
                            ...
                            We ensure you have free interaction with staff members to get help on any problems related to different subjects. <a href="registration.do" class="w3-text-teal">Register now</a> for free to take a look at our queries system.</p>
                        </div>
                    	<div class="w3-half w3-margin-top">
                        <img class="w3-card-2" src="${img1 }" style="width:100%">
                        </div>
