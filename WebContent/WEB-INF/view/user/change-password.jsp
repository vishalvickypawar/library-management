...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <form class="w3-form w3-margin-left w3-margin-right" action="change-password-action.do" method="post"  onsubmit="initial();">
        <input id="t" class="w3-input w3-border w3-light-grey w3-hover-white" type="hidden" name="time">
            ...
            <p>
            <label class="w3-label"><b>Current Password</b></label>
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="password" name="curpass" required>
            </p>
            <p>
            <label class="w3-label"><b>New Password</b></label>
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="password" name="newpass" required pattern=".{8,}" title="Minimum 8 characters">
            </p>
            <p>
            <label class="w3-label"><b>Confirm Password</b></label>
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="password" name="newpassconfirm" required>
            </p>
            <p>
