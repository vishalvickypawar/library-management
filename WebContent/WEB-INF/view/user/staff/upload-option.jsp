...
<spring:url value="/resources/icons/font-awesome_4-6-3_file-pdf-o_256_50_ffffff_none.png" var="img3"/>
<spring:url value="/resources/icons/font-awesome_4-6-3_play-circle_256_50_ffffff_none.png" var="img4"/>
...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <a href="upload-pdf.do" style="text-decoration:none">
        <div class="w3-teal w3-container w3-hover-shadow w3-margin">
        <img src="${img3 }" style="width:60%" class><h3>PDF</h3>
        </div>
        </a>
        </div>
        <div class="w3-half w3-padding w3-center w3-hover-light-grey">
        <a href="upload-videos.do" style="text-decoration:none">
        <div class="w3-teal w3-container w3-hover-shadow w3-margin">
        <img src="${img4 }" style="width:60%"><h3>Video</h3>
        </div>
        </a>
        </div>
