...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <c:when test="${filetype=='pdf' }">
        	<a href="upload-pdf.do" class="w3-left w3-padding-top"><img src="${back }" width="50px"></a>
        </c:when>
        <c:when test="${filetype=='video' }">
        	<a href="upload-videos.do" class="w3-left w3-padding-top"><img src="${back }" width="50px"></a>
        </c:when>
        </c:choose>
  			<h2> &nbsp;Upload</h2>
		</div>
