...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div class="w3-row w3-content w3-padding w3-margin-top">
          ...
          <a href="queries.do">
            <div class="w3-half tablink w3-bottombar w3-hover-light-grey w3-padding">All Questions and Answers</div>
          </a>
          <a href="queries-my.do">
            <div class="w3-half tablink w3-bottombar w3-hover-light-grey w3-padding w3-border-teal">My Answers</div>
          </a>
        </div>
        
        <div class="topic w3-content w3-padding-bottom">
        	<div class="w3-card-4 w3-margin">
            	<div class="w3-container w3-teal"><h2>My Answers</h2></div>
        		<ul class="w3-ul">
                <c:forEach items="${sessionScope.questions }" var="questions" varStatus="loop">
                  <li id="q${loop.index}" class="w3-row w3-hover-light-grey" onclick="showAns('a${loop.index}')" style="display:none" title="Click to show answers">
                    ...
                    <div class="w3-half w3-padding">
                  	...
                  	<div class="w3-quarter w3-right w3-margin-top">
                        <p class="w3-right w3-margin-right"><span id="r${loop.index }" class="w3-badge w3-red w3-padding"></span></p>
                    </div>
                  </li>
                  ...
                  <c:forEach items="${sessionScope.answers }"  var="answers">
                	<c:if test="${answers.question.id == questions.id}">
                	  ...
                	  if("${answers.question.id}" == "${questions.id}"){
                		  n++;
                	  	  showQue("q${loop.index}");
                	  	  rpy("r${loop.index}",n);
                	  }
                	  </script>
                      <li class="w3-row w3-margin-left">
                        ...
                        <div class="w3-half w3-padding w3-margin-left">
                            <span>${answers.answer }</span>
                        </div>
                        <form action="delete-answer.do" onsubmit="initial();">
                        <p>
                        ...
                        <input type="hidden" name="answer" value="${answers.id }">
						<input type="submit" class="w3-btn w3-padding w3-margin-right w3-margin-top w3-medium w3-right w3-teal w3-hover-red" style="height:39px"
								value="Delete">
	                    </form>
                      </li>
                    </c:if>
