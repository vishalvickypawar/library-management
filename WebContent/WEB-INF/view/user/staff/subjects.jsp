...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div class="w3-card-2 w3-content w3-margin">
        <div class="w3-content w3-teal">
        <h2 class="w3-center w3-margin w3-padding">Subjects</h2>
        </div>
        
        <ul class="w3-navbar w3-content w3-margin w3-row-padding">
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-physics.do">Physics</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-java.do">Java</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-digital-electronics.do">Digital Electronics</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-chemistry.do">Chemistry</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-web-designing.do">Web Designing</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-microprocessor.do">Microprocessor</a>
        </li>
        <li class="w3-third w3-margin-bottom w3-margin-top"><a class="w3-btn w3-padding-24 w3-teal" href="subjects-other.do">Other</a>
        </li>
        </ul>
        
        <div class="w3-content" style="text-align:right">
        	<a href="upload.do"><button class="w3-btn w3-margin w3-teal">Upload New File</button></a>
        	<a href="recent-upload.do"><button class="w3-btn w3-margin w3-teal">My Recent Uploads</button></a>
        </div>
        </div>
