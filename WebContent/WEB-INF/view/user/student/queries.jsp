    ...
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div class="w3-row w3-content w3-padding w3-margin-top">
          ...
          <a href="queries-my.do">
            <div class="w3-half tablink w3-bottombar w3-hover-light-grey w3-padding">My Questions</div>
          </a>
        </div>
        ...
        <div class="topic w3-content w3-padding-bottom">
        	<div class="w3-card-4 w3-margin">
        		...
        		<ul class="w3-ul">
        		<li>
        			<form class="w3-form w3-margin-left w3-margin-right" action="question.do" onsubmit="initial();">
        				<p>
        				<input id="t" class="w3-input w3-border w3-light-grey w3-hover-white" type="hidden" name="time">
        				</p>
                        <p>
                        <label class="w3-label"><b>Question</b></label>
                        <textarea class="w3-input w3-border w3-light-grey w3-hover-white" name="question" required></textarea>
                        </p>
                        <p>
