...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div class="w3-row-padding w3-container w3-padding">
            ...
            <p><div class="w3-text-teal">Course </div>
            			<c:choose>
            				<c:when test="${user.course=='10+2' }">10+2
            				</c:when>
            				<c:when test="${user.course=='btechcs' }">B.Tech(Computer Science)
            				</c:when>
            				<c:when test="${user.course=='btechee' }">B.Tech(Electrical Engineering)
            				</c:when>
            				<c:when test="${user.course=='btechec' }">B.Tech(Electronics & Communication)
            				</c:when>
            				<c:when test="${user.course=='btechme' }">B.Tech(Mechanical)
            				</c:when>
            				<c:when test="${user.course=='btechce' }">B.Tech(Civil)
            				</c:when>
            				<c:when test="${user.course=='bsc' }">B.Sc
            				</c:when>
            				<c:when test="${user.course=='bca' }">BCA
            				</c:when>
            			</c:choose>
            </p>
