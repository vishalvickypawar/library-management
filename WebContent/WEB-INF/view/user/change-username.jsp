...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <form class="w3-form w3-margin-left w3-margin-right" action="change-username-action.do" method="post"  onsubmit="initial();">
            ...
            <p>
            <label class="w3-label"><b>New Username</b></label>
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="text" name="newuser" required pattern="^[a-zA-Z0-9._]+$" title="Letters digits . and _ ">
            </p>
            <p>
