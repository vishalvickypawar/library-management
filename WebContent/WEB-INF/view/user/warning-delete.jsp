...
<spring:url value="/resources/icons/font-awesome_4-6-3_warning_256_0_f52d27_none.png" var="warning"/>
...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div class="w3-row w3-content w3-margin-top w3-center" style="max-width:300px">
        <img src=${warning } width="70%"><br>
        <p>Do you want to delete your account?<br>(All your data, uploaded files, questions/answers will be deleted!)</p>
        <p>
        <form action="delete-account.do"  onsubmit="initial();">
        <input id="t" class="w3-input w3-border w3-light-grey w3-hover-white" type="hidden" name="time">
        <input type="submit" value="Yes, Delete my account" class="w3-btn w3-teal w3-hover-red">
        </form>
        <p><a href="profile.do" class="w3-btn w3-teal">No, Go back to My Profile</a></p>
        </div>
