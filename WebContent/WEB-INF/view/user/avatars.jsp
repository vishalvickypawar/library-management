...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <a href="avatar${i}.do"><img class="w3-margin w3-card-2 w3-hover-opacity" src="${pageContext.request.contextPath }/images/0${i}.jpg" width="100px"></a>
        </c:forEach>
		<c:forEach var="i" begin="10" end="33">
        <a href="avatar${i}.do"><img class="w3-margin w3-card-2 w3-hover-opacity" src="${pageContext.request.contextPath }/images/${i}.jpg" width="100px"></a>
        </c:forEach>
        </div>
        </div>
        </div>
