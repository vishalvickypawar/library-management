...
<spring:url value="/resources/icons/font-awesome_4-6-3_warning_256_0_f52d27_none.png" var="img1"/>
    ...
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <div id="menu" style="max-width:inherit">
            <ul id="top" class="w3-navbar w3-light-grey w3-card-2">
                ...
                <li class="w3-hide-small"><a class="w3-hover-teal" href="login.do"><i class="fa fa-question-circle"></i> Queries</a></li>
            ...
            <ul id="down-menu" class="w3-navbar w3-light-grey w3-hide-medium w3-hide-large w3-card-2" style="display:none">
                ...
                <li><a class="w3-hover-teal" href="login.do"><i class="fa fa-book"></i> Subjects</a></li>
                <li><a class="w3-hover-teal" href="login.do"><i class="fa fa-question-circle"></i> Queries</a></li>
        ...
        <div class="w3-container w3-teal w3-margin-top">
        	<a href="home.do" class="w3-left w3-padding-top"><img src="${back }" width="50px"></a>
  			<h2> &nbsp;Session Expired</h2>
		</div>
		</div>
        <div class="w3-row w3-content w3-padding-32 w3-margin-top w3-center" style="max-width:300px">
        <img src=${img1 } width="70%"><br>
        <p>You are logged out<br><br><a href="login-second.do" class="w3-btn w3-teal">Login Again</a></p>
        </div>
