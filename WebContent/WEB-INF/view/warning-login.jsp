...
<spring:url value="/resources/icons/font-awesome_4-6-3_user_256_0_000000_none.png" var="img1"/>
...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <p>You need to login to view this page!<br><br><a href="login.do" class="w3-btn w3-teal">Login Now</a></p>
        </div>
