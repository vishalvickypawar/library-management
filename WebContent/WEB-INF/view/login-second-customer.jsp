    ...
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        <div id="heading" class="w3-container w3-margin-bottom w3-padding-top">
                ...
                <div class="w3-container w3-right w3-hide-small">
                    <a class="w3-btn w3-teal w3-margin-top w3-card-2" href="login.do"><i class="fa fa-user"></i> Login</a>
        ...
        <div id="menu" style="max-width:inherit">
            <ul id="top" class="w3-navbar w3-light-grey w3-card-2">
                ...
                <li class="w3-hide-medium w3-hide-large w3-opennav w3-light-grey w3-right">
                    <a title="Login" class="w3-teal" style="height:38px" href="login.do"><i class="fa fa-user" style="margin-top:5px"></i></a>
                </li>
                ...
                <li class="small-buttons w3-hide-small w3-right" style="display:none" title="Login">
                	<a class="w3-teal" href="login.do" style="height:39px"><i class="fa fa-user" style="margin-top:5px"></i></a>
                </li>
            </ul>
            <ul id="down-menu" class="w3-navbar w3-light-grey w3-hide-medium w3-hide-large w3-card-2" style="display:none">
                <li><a class="w3-hover-teal" href="warning-login.do"><i class="fa fa-sticky-note"></i> About Us</a></li>
        ...
        <div class="w3-content w3-padding-bottom" style="max-width:700px">
        <div class="w3-card-4 w3-margin">
        <div class="w3-container w3-teal">
        	<a href="login.do" class="w3-left w3-padding-top"><img src="${back }" width="50px"></a>
  			<h2> &nbsp;Login</h2>
		</div>
        ...
        <c:choose>
         <c:when test="${user.profile == 'nopic'}">
        	<img src="${img1 }" class="w3-circle w3-border" style="width:100%; max-width:200px">
         </c:when>
         <c:otherwise>
         	<img src="${pageContext.request.contextPath }/images/${profilepic}" class="w3-circle w3-border" style="width:100%; max-width:200px">
         </c:otherwise>
        </c:choose>
        </div>
        <form class="w3-form w3-twothird" action="login-second-action.do" method="post" onsubmit="initial();">
            ...
            <input class="w3-input w3-border w3-light-grey" type="text" name="user" value="${username }" required disabled>
            <input class="w3-input w3-border w3-light-grey" type="hidden" name="user" value="${username }" required>
            </p>
            <p>
            <label class="w3-label"><b>Password</b></label>
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="password" name="pass" required>
            </p>
            <p>
            <input type="submit" class="w3-btn w3-teal" value="Login">
            </p>
        </form>
        <p class="w3-container w3-left">Not Registered? <a href="registration.do" class="w3-hover-text-teal">click here</a></p>
        <p class="w3-container w3-right">Forgot Password? <a href="forgot-password.do" class="w3-hover-text-teal">click here</a></p>
        </div>
        </div>
        </div>
    </div>
