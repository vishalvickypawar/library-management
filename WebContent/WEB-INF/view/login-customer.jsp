...
<body class="w3-light-grey">
    <div class="w3-content w3-white w3-card-4" style="min-height:1000px">
        ...
        <form class="w3-form w3-twothird" action="login-action.do" onsubmit="initial();">
            ...
            <input class="w3-input w3-border w3-light-grey w3-hover-white" type="text" name="user" required autofocus>
            </p>
            <p>
            <label class="w3-label"><b>Login as</b></label>
            <select class="w3-select w3-border w3-light-grey w3-hover-white" name="type" required>
        ...
        <p class="w3-container">Not Registered? <a href="registration.do" class="w3-hover-text-teal">click here</a></p>
        </div>
        </div>
        </div>
    </div>
